 ...
 *
 * <p>A Arad Socket is created by using one of its subclasses. They will take an existing {@link
 ...
 * selector loop.
 */
public interface AradSocket extends ByteChannel, GatheringByteChannel, ScatteringByteChannel {
   ...
   * @see AradSocketBuilder#withSessionInitCallback(Consumer)
   */
   ...
   * @see AradSocketBuilder#withPlainBufferAllocator(BufferAllocator)
   ...
   *
   * @return the buffer allocator
   * @see AradSocketBuilder#withEncryptedBufferAllocator(BufferAllocator)
   * @see TrackingAllocator
   */
   ...
   * @see AradSocketBuilder#withRunTasks(boolean)
   */
  boolean getRunTasks();
   ...
   * AradSocketBuilder#withWaitForCloseConfirmation}.
   *
   ...
   * @throws WouldBlockException if the channel is in non-blocking mode and the IO operation cannot
   *     be completed immediately
   * @see AradSocketBuilder#withWaitForCloseConfirmation(boolean)
   */
