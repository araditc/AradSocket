 ...
 *
 * <p>This class inherits from {@link IOException} as a compromise to allow {@link AradSocket} to
 * throw it while still implementing the {@link ByteChannel} interface.
 */
public abstract class AradSocketFlowControlException extends IOException {
  private static final long serialVersionUID = -2394919487958591959L;

  public AradSocketFlowControlException() {
    super();
  }
