...
/** A client-side {@link AradSocket}. */
public class ClientAradSocket implements AradSocket {

  /** Builder of {@link ClientAradSocket} */
  public static class Builder extends AradSocketBuilder<Builder> {
    ...
    public ClientAradSocket build() {
      return new ClientAradSocket(
          underlying,
  ...
  private final AradSocketImpl impl;

  private ClientAradSocket(
