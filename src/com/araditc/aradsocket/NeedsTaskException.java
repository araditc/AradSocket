 ...
 * operation (typically a TLS handshaking) needs to be executed and the {@link AradSocket} is
 ...
 * in OpenSSL, the task is executed by the library, while with the {@link AradSocket}, the calling
 * code is responsible for the execution).
 *
 * @see <a href="https://www.openssl.org/docs/man1.1.0/ssl/SSL_get_error.html">OpenSSL error
 *     documentation</a>
 */
public class NeedsTaskException extends AradSocketFlowControlException {
